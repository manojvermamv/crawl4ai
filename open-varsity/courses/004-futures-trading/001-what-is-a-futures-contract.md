Chapters
Module A · What a Future Is - Chapter 01
...
![The skeleton of every futures contract is a deal between a buyer and a seller that fixes the underlying, the agreed price, the lot size and the expiry date today, for settlement later.](https://openalgo.in/futures/images/diagram-what-is-a-future.png) DiagramThe skeleton of every futures contract is a deal between a buyer and a seller that fixes the underlying, the agreed price, the lot size and the expiry date today, for settlement later.
