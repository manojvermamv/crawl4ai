...
![Position sizing worked backward from the stop: the trader fixes a small risk budget, measures the rupee loss of one lot from the stop distance, and divides to find how many lots fit, which is often just one.](https://openalgo.in/futures/images/diagram-position-sizing.png) DiagramPosition sizing worked backward from the stop: the trader fixes a small risk budget, measures the rupee loss of one lot from the stop distance, and divides to find how many lots fit, which is often just one.
