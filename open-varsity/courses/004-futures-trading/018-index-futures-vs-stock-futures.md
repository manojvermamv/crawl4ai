Chapters
Module E · Settlement and Positioning - Chapter 18
...
![RELIANCE daily candles over the last 120 sessions, closing near Rs 1,318; a single-stock future lives or dies on this one company's news, and an overnight surprise can open the next candle far from the last close.](https://openalgo.in/futures/images/chart-reliance-daily.png) ChartRELIANCE daily candles over the last 120 sessions, closing near Rs 1,318; a single-stock future lives or dies on this one company's news, and an overnight surprise can open the next candle far from the last close.
