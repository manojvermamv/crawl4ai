...
![The three-step audit check: first find your turnover, then test it against the right threshold, then check the special presumptive-tax rules before concluding anything.](https://openalgo.in/taxation/images/diagram-fno-audit-steps.png) DiagramThe three-step audit check: first find your turnover, then test it against the right threshold, then check the special presumptive-tax rules before concluding anything.
