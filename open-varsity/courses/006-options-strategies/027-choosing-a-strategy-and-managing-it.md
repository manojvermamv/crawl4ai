Chapters
Module G · Funding, Adjusting and Choosing - Chapter 27
...
![The view-to-strategy selector: bullish, bearish, neutral, and big-move opinions each map to the defined-risk structures that fit them, so you choose the shape that matches what you actually expect NIFTY to do.](https://openalgo.in/options-strategies/images/diagram-strategy-by-view.png) DiagramThe view-to-strategy selector: bullish, bearish, neutral, and big-move opinions each map to the defined-risk structures that fit them, so you choose the shape that matches what you actually expect NIFTY to do.
