Chapters
Module B · The Contract and Settlement - Chapter 05
...
![The three numbers that define every option are the premium, the strike and the expiry, shown here alongside the RELIANCE symbol broken into its base, date, strike and type.](https://openalgo.in/options-basics/images/diagram-premium-strike-expiry.png) DiagramThe three numbers that define every option are the premium, the strike and the expiry, shown here alongside the RELIANCE symbol broken into its base, date, strike and type.
